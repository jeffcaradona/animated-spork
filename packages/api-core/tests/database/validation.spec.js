...
describe('Database Validation', () => {
  ...
  describe('validateDatabaseConfig', () => {
    ...
    describe('backend validation', () => {
      it('should throw if backend is missing', () => {
        expect(() => validateDatabaseConfig({ databases: {} }))
          .to.throw(ConfigurationError)
          .with.property('message', 'Database configuration requires a backend property');
      });
      ...
      it('should throw if backend is unsupported', () => {
        expect(() => validateDatabaseConfig({ backend: 'postgres', databases: {} }))
          .to.throw(ConfigurationError)
    ...
    describe('databases object validation', () => {
      it('should throw if databases is missing', () => {
        expect(() => validateDatabaseConfig({ backend: 'sqlite' }))
          .to.throw(ConfigurationError)
          .with.property('message', 'Database configuration requires a databases object');
      });

      it('should throw if databases is not an object', () => {
        expect(() => validateDatabaseConfig({ backend: 'sqlite', databases: 'invalid' }))
          .to.throw(ConfigurationError)
          .with.property('message', 'Database configuration requires a databases object');
      });
  ...
  describe('validateDatabaseConfigForBackend', () => {
    describe('common validation', () => {
      it('should throw if dbConfig is undefined', () => {
        expect(() => validateDatabaseConfigForBackend('test', undefined, 'sqlite'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' configuration must be an object");
      });

      it('should throw if dbConfig is not an object', () => {
        expect(() => validateDatabaseConfigForBackend('test', 'invalid', 'sqlite'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' configuration must be an object");
      });
    });
    ...
    describe('SQLite validation', () => {
      it('should accept empty config (defaults to :memory:)', () => {
        expect(() => validateDatabaseConfigForBackend('test', {}, 'sqlite'))
          .to.not.throw();
      });

      it('should accept valid filename', () => {
        expect(() => validateDatabaseConfigForBackend('test', { filename: './test.db' }, 'sqlite'))
          .to.not.throw();
      });

      it('should throw if filename is not a string', () => {
        expect(() => validateDatabaseConfigForBackend('test', { filename: 123 }, 'sqlite'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' filename must be a string");
      });

      it('should accept valid readonly flag', () => {
        expect(() => validateDatabaseConfigForBackend('test', { readonly: true }, 'sqlite'))
          .to.not.throw();
      });

      it('should throw if readonly is not a boolean', () => {
        expect(() => validateDatabaseConfigForBackend('test', { readonly: 'yes' }, 'sqlite'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' readonly must be a boolean");
      });

      it('should accept valid timeout', () => {
        expect(() => validateDatabaseConfigForBackend('test', { timeout: 5000 }, 'sqlite'))
          .to.not.throw();
      });
      ...
      it('should throw if timeout is not a number', () => {
        expect(() => validateDatabaseConfigForBackend('test', { timeout: '5000' }, 'sqlite'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' timeout must be a positive number");
      });

      it('should throw if timeout is not positive', () => {
        expect(() => validateDatabaseConfigForBackend('test', { timeout: 0 }, 'sqlite'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' timeout must be a positive number");
      });
    });

    describe('MSSQL validation', () => {
      ...
      it('should accept valid MSSQL config', () => {
        expect(() => validateDatabaseConfigForBackend('test', validMssqlConfig, 'mssql'))
          .to.not.throw();
      });
      ...
      it('should throw if database is missing', () => {
        ...
        expect(() => validateDatabaseConfigForBackend('test', config, 'mssql'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' requires a database property");
      });
      ...
      it('should throw if authentication is missing', () => {
        ...
        expect(() => validateDatabaseConfigForBackend('test', config, 'mssql'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' requires an authentication object");
      });
      ...
      it('should throw if authentication.type is missing', () => {
        ...
        expect(() => validateDatabaseConfigForBackend('test', config, 'mssql'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' authentication requires a type property");
      });
      ...
      it('should throw if authentication.options is missing for type default', () => {
        ...
        expect(() => validateDatabaseConfigForBackend('test', config, 'mssql'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' authentication requires options for type 'default'");
      });
      ...
      it('should throw if userName is missing', () => {
        ...
        expect(() => validateDatabaseConfigForBackend('test', config, 'mssql'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' authentication options requires userName");
      });
      ...
      it('should throw if password is missing', () => {
        ...
        expect(() => validateDatabaseConfigForBackend('test', config, 'mssql'))
          .to.throw(ConfigurationError)
          .with.property('message', "Database 'test' authentication options requires password");
      });
      ...
      describe('pool configuration', () => {
        ...
        it('should throw if pool.min is negative', () => {
          ...
          expect(() => validateDatabaseConfigForBackend('test', config, 'mssql'))
            .to.throw(ConfigurationError)
            .with.property('message', "Database 'test' pool.min must be a non-negative number");
        });
        ...
        it('should throw if pool.max is less than 1', () => {
          ...
          expect(() => validateDatabaseConfigForBackend('test', config, 'mssql'))
            .to.throw(ConfigurationError)
            .with.property('message', "Database 'test' pool.max must be a positive number");
        });
        ...
        it('should throw if pool.min > pool.max', () => {
          ...
          expect(() => validateDatabaseConfigForBackend('test', config, 'mssql'))
            .to.throw(ConfigurationError)
            .with.property('message', "Database 'test' pool.min cannot be greater than pool.max");
        });
        ...
        it('should throw if idleTimeoutMillis is negative', () => {
          ...
          expect(() => validateDatabaseConfigForBackend('test', config, 'mssql'))
            .to.throw(ConfigurationError)
            .with.property('message', "Database 'test' pool.idleTimeoutMillis must be a non-negative number");
        });

        it('should throw if acquireTimeoutMillis is negative', () => {
          const config = { ...validMssqlConfig, pool: { acquireTimeoutMillis: -1 } };
          expect(() => validateDatabaseConfigForBackend('test', config, 'mssql'))
            .to.throw(ConfigurationError)
            .with.property('message', "Database 'test' pool.acquireTimeoutMillis must be a non-negative number");
        });
      });
  ...
  describe('validateHealthCheckConfig', () => {
    ...
    it('should accept empty object', () => {
      expect(() => validateHealthCheckConfig({}))
        .to.not.throw();
    });

    it('should accept valid enabled flag', () => {
      expect(() => validateHealthCheckConfig({ enabled: true }))
        .to.not.throw();
      expect(() => validateHealthCheckConfig({ enabled: false }))
        .to.not.throw();
    });
    ...
    it('should throw if intervalMs is not a number', () => {
      expect(() => validateHealthCheckConfig({ intervalMs: '30000' }))
        .to.throw(ConfigurationError)
        .with.property('message', 'healthCheck.intervalMs must be a positive number');
    });
    ...
    it('should throw if queryMs is not a number', () => {
      expect(() => validateHealthCheckConfig({ queryMs: '5000' }))
        .to.throw(ConfigurationError)
        .with.property('message', 'healthCheck.queryMs must be a positive number');
    });
