...
describe('Database Errors', () => {
  ...
  describe('ConnectionError', () => {
    it('should be a DatabaseError with correct properties', () => {
      const err = new ConnectionError('Cannot connect', { server: 'localhost' });
      expect(err).to.be.instanceOf(DatabaseError);
  ...
  describe('DatabaseNotFoundError', () => {
    it('should be a DatabaseError with correct properties', () => {
      const err = new DatabaseNotFoundError('reporting', { available: ['default'] });
      expect(err).to.be.instanceOf(DatabaseError);
  ...
  describe('TransactionError', () => {
    it('should be a DatabaseError with correct properties', () => {
      const err = new TransactionError('Commit failed', { operation: 'commit' });
      expect(err).to.be.instanceOf(DatabaseError);
  ...
  describe('PermissionError', () => {
    it('should be a DatabaseError with correct properties', () => {
      const err = new PermissionError('Access denied', { user: 'api', operation: 'INSERT' });
      expect(err).to.be.instanceOf(DatabaseError);
  ...
  describe('InternalDatabaseError', () => {
    it('should be a DatabaseError with correct properties', () => {
      const err = new InternalDatabaseError('Driver error', { driver: 'mssql' });
      expect(err).to.be.instanceOf(DatabaseError);
  ...
  describe('Helper Functions', () => {
    ...
    describe('isClientError()', () => {
      ...
      it('should return false for 5xx errors', () => {
        ...
        expect(isClientError(new InternalDatabaseError('Test', {}))).to.be.false;
      });
    ...
    describe('isServerError()', () => {
      ...
      it('should return false for 4xx errors', () => {
        ...
        expect(isServerError(new DatabaseNotFoundError('test', {}))).to.be.false;
  ...
  describe('Express Middleware Compatibility', () => {
    it('should work with Express next(error) pattern', () => {
      const err = new ConnectionError('Database unavailable', { databaseName: 'default' });
